...
public class ChannelVO implements Serializable {
	...
	private String div;		//NN
	private String genre;	//NN
	private String num;		//NN
	private String idx;
	private String title;	//NN
	private String url;		//NN
	private String info;
	private int good;
	private int click;
	private int zzim;
	private String email;	//NN
	private String t_idx;	//NN
	private java.util.Date wdate;//NN
	
	public ChannelVO() {
		
	}

	public ChannelVO(String div, String genre, String num, String idx, String title, String url, String info, int good,
